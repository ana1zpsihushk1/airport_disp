...
void Airplane::startFlight(Strip* targetStrip)
{
    ...
    if (type == "WideBody" || type == "Cargo") flightDuration = 10.f;
    else if (type == "NarrowBody") flightDuration = 10.f;
    else if (type == "Regional") flightDuration = 10.f;
    else flightDuration = 10.f;
